...
//		this.addFace(new Vector3(0,1,4));
//		this.addFace(new Vector3(0,2,4));
//		this.addFace(new Vector3(2,4,7));
//		this.addFace(new Vector3(0,2,4));
//		this.addFace(new Vector3(2,3,7));
//		this.addFace(new Vector3(0,4,5));
//		this.addFace(new Vector3(3,5,6));
//		this.addFace(new Vector3(3,6,7));
//		this.addFace(new Vector3(4,5,6));
//		this.addFace(new Vector3(4,6,7));
	}
}
